...
class Player(pygame.sprite.Sprite):
    def __init__(self, game_mode):
        ...
        if self.game_mode == "Neuroevolution":
            ...
            layer_sizes = [4, 10, 15 , 2]  # TODO (Design your architecture here by changing the values)
    ...
    def think(self, screen_width, screen_height, obstacles, player_x, player_y):
        ...
        if len(obstacles):
                input = np.array([obstacles[0]['y'] / 756, int(obstacles[0]['x'])/600 ,player_y/800, player_x / 604])
        else:
